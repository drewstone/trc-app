...
export default function About({ switchTo, screens }) {
  return (
    <div>
            ...
            <div className="container">
              ...
              <div id="navbarMenu" className="navbar-menu">
                <div className="navbar-end">
                  ...
                  <a className="navbar-item is-size-5 is-active" onClick={() => switchTo(screens.ABOUT)}>
                    ABOUT
                  </a>
                  <a className="navbar-item is-size-5" onClick={() => switchTo(screens.CONTACT)}>
                    CONTACT
                  </a>
